...
const uname: string | null = username;
const bYr: number | undefined = birthYr;

const curAge =
  new Date().getFullYear() - (typeof bYr === "number" ? bYr : 1990);

console.log(
  `Dear ${typeof uname === "string" ? uname : "admin"}, you're ${curAge} years old now!`,
);
