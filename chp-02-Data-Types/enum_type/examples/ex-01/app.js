...
function login(username, password) {
    var userFound = users.filter(function (user) { return user.username === username && user.password === password; });
    if (userFound.length > 0) {
        var message = "Hello Mr./Ms. " + userFound[0].name + ", you've been alloted with the role of ";
