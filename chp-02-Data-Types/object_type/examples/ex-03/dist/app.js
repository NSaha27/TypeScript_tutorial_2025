...
console.log(`*The customer is ${customer.isLoggedIn ? "logged in" : "not logged in"}!`);
    ...
    projects: [
        {
            ...
            description: "It is a full-fledged website of a hotel chain, that provided fooding, catering and lodging facilities",
